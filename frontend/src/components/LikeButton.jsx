...
<<<<<<< HEAD
    return null; 
=======
    return null; // Or show a disabled button, linking to login
...
=======
  ...
  return (
    <button onClick={handleLike} className="flex items-center space-x-1 text-gray-600 hover:text-red-500 transition-colors duration-200">
      {hasLiked ? (
        // Filled Heart (Liked)
